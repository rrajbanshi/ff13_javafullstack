...
import com.examples.empapp.service.JdbcService;
import com.examples.empapp.service.JdbcServiceImpl;
...
//							empService.bulkExport();
	...
	private static void printStatistics() {
		...
		System.out.println("No of employees older than thirty years: "
				+ jdbcService.getEmployeeCountAgeGreaterThan(30));
		System.out.println("List employee IDs older than 30 years: " + jdbcService.getEmployeeIdsAgeGreaterThan());
		System.out.println("Employee count by Department: " + jdbcService.getEmployeeCountByDepartment());
		System.out.println("Employee count by Department ordered: " + jdbcService.getEmployeeCountByDepartmentOdered());
	}
